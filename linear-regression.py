...
#For multiple features and prediction of all the values of the feature in test dataset: 
...
#For prediction on the basis of distance*user input*
chicago_taxi_dataset = pd.read_csv("https://download.mlcc.google.com/mledu-datasets/chicago_taxi_train.csv")
...
sas = float(input("Enter the distance(in miles):\n"))
result = predict_fare(model_1, sas, features[0])
print(result)